# Panduan Deployment ENS Custom Chain — OorthNexus

Dokumen ini mencakup seluruh proses deployment ENS contracts di custom chain OorthNexus (Chain ID: 131), setup subgraph + BENS untuk integrasi Blockscout explorer, dan cara registrasi domain ENS.
...
## Appendix: Contract Addresses Lengkap
...
_Dokumen ini dibuat berdasarkan deployment aktual di OorthNexus Chain ID 131. Semua contract addresses di atas adalah production addresses yang sudah live._
